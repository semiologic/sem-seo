...
EOF;
	...
	function entry_editor()
	{
		...
		echo '<p>These fields let you override entry-specific SEO meta fields. They work in exactly the same way as their site-wide counterparts, which you can configure under <a href="' . trailingslashit(site_url()) . 'wp-admin/options-general.php?page=' . plugin_basename(__FILE__) . '" onclick="window.open(this.href); return false;">Settings / SEO Meta</a>.</p>';
